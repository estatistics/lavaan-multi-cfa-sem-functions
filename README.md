...
- It can help identifies extreme cases across all datasets simultaneously.
...
- Make a nice table of Fit measures across many lavaan analyses eg. Time 1, Time 2, Time 3, all binded in a single table.
